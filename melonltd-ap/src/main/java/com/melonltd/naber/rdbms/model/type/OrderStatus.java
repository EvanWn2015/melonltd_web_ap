...
public enum OrderStatus {
	...
	PROCESSING("PROCESSING", "老闆已經接到你的訂單囉！取餐時間到記得去取餐哦！"), // 原：商家已接收到您的訂單並且開始製作囉! 
	...
	public static List<OrderStatus> getSellerCancelType(){
		return Lists.<OrderStatus>newArrayList(CANCEL, FAIL);
	}
}
