...
public class MyTest {
	...
	@Test
	public void myTest() {
		VerifyPhoneLogVo vo = new VerifyPhoneLogVo();
		vo.setPhone_number("0928297076");
		vo.setCode("622026");
		String json = JsonHelper.toJson(vo);
		System.out.println(Base64Service.encode(json));
		Instant instant = Instant.parse("2018-06-02T00:26:40.4510Z");
...
//			System.out.println(new StringBuffer("發送簡訊成功：餘額").append(String.valueOf(sms.getCreditValue())).append("簡訊批號")
//					.append(sms.getBatchID()).toString());
//		} else {
//			System.out.println(new StringBuffer("發送簡訊失敗：原因").append(sms.getProcessMsg()).toString());
//		}
	}
	...
	public void checkNotNull () {
		...
		LocalDate localDate = LocalDate.parse("2018-06-02T22:00:23.1400Z", DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSSS'Z'"));
